...
## Project Structure
    ...
    ├── alliance_residentia_36431  # Django project configurations
...
1. Clone this repo and `cd alliance_residentia_36431`
...
2. Clone this repo and `cd alliance_residentia_36431`
